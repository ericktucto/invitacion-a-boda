...
export default function PageFechas() {
  return <div className="pagefechas page-full relative overflow-hidden">
    <img src="/invitacion-a-boda/img/flores.png" alt="" className="position-top-right" width="240" />
    <img src="/invitacion-a-boda/img/flores.png" alt="" className="position-bottom-left" width="240" />
